...
class ConformerEncoder(nn.Module):
    ...
    def __init__(self, encoder_dim=256, num_blocks=16, att_heads=4, kernel_size=32, input_dim=80):
        ...
        #conformer block x N
        self.blocks = [ConformerBlock(dim_model=encoder_dim, attn_heads=att_heads, kernel_size=kernel_size) for x in range(num_blocks)]
